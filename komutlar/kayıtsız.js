...
module.exports.run = async (client, message, args) => {
    ...
    return message.channel
      .send(
        new MessageEmbed()
          ...
          .setDescription(
            `${message.author} Bu Komutu Kullanmak İçin Yetkin Bulunmamakta!`
  ...
  if (!member)
    return message.channel
      .send(` **Bir kişi etiketlemelisin!**`)
      .then((x) => x.delete({ timeout: 5000 })); // burayı değiştirebilirsiniz
